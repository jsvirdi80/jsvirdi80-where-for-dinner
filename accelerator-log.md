...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=jsvirdi80&repo=jsvirdi80%2Fwhere-for-dinner",
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=jsvirdi80&repo=jsvirdi80%2Fwhere-for-dinner","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"$2a$10$J/EWz6Q8zxRHYCr2UwJewe5hN6uKhbytUuGGC2yHvEJ2zhH.dLvZe","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"tap-deploy","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input6927210649124122020, --data-values-file, /tmp/accelerator-options7478046567159896781.json, --output-files, /tmp/ytt-output9013006169387593295]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=jsvirdi80&repo=jsvirdi80%2Fwhere-for-dinner","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"$2a$10$J/EWz6Q8zxRHYCr2UwJewe5hN6uKhbytUuGGC2yHvEJ2zhH.dLvZe","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"tap-deploy","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input6187939723204605251, --data-values-file, /tmp/accelerator-options6932645992726522968.json, --output-files, /tmp/ytt-output15174062992381183236]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=jsvirdi80&repo=jsvirdi80%2Fwhere-for-dinner","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"$2a$10$J/EWz6Q8zxRHYCr2UwJewe5hN6uKhbytUuGGC2yHvEJ2zhH.dLvZe","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"tap-deploy","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input13468691043943640144, --data-values-file, /tmp/accelerator-options15920195417252815005.json, --output-files, /tmp/ytt-output9631477581870268537]
